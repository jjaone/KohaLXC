...
use Koha::Borrower::Debarments qw/AddDebarment/;
use Koha::Auth::PermissionManager;

require ConversionTable::BorrowernumberConversionTable;
...
#    my $dbh = C4::Context->dbh;
    ...
    $data->{'borrowernumber'}=C4::SQLHelper::InsertInTable("borrowers",$data,1);
...
sub processNewFromRow {
    ...
    $patron->{borrowernumber} = myAddMember($patron) unless $old_borrowernumber;
